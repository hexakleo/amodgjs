...
const modGUI = {
  ...
  createLiveOverlay(headerText) {
    ...
    header.style.fontWeight = 'italic';
  ...
  modGUI.GUI.menus.forEach(menu => {
    ...
    menuContainer.style.cursor = 'cross';
    menuContainer.style.fontFamily = 'monospace';
    ...
    menuContainer.style.padding = '20.2px';
    ...
    menu.elements.forEach(element => {
      ...
      if (element.type === 'button') {
        ...
        buttonElem.addEventListener('mouseenter', () => {
          buttonElem.style.backgroundColor = 'rgba(255, 255, 225, 1.2)';
        });

        buttonElem.addEventListener('mouseleave', () => {
          buttonElem.style.backgroundColor = 'rgba(255, 255, 255, 0.6)';
        });
        ...
        sliderInput.style.height = '16.6px';
